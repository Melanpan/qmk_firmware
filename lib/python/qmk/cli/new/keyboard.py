...
def new_keyboard(cli):
    ...
    files = {'config.h', 'info.json', 'readme.md', 'rules.mk', final_directory + '.c', final_directory + '.h', 'keymaps/default/keymap.c', 'keymaps/default/config.h', 'keymaps/default/readme.md'}
    for file in files:
